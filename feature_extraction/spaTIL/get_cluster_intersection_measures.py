...
def get_cluster_intersection_measures(groups, n):
    ...
    for i in range(num_comb):
        ...
        for j in range(num_clust1-1):
            ...
            if 'neighborsPerGroup' in group1 and comb[i][1] < len(group1['neighborsPerGroup']):
        ...
        if not int_areas:
            ...
            features.extend(getFeatureStats(int_areas) +
        ...
        meas = [f'IntersectedAreaClusters_G{gr1}&{gr2}',

...
from get_graph_features import get_graph_features  # Assuming you have a function for graph features
...
def getGraphFeatures(groups):
    ...
    for i in range(num_groups):
        ...
        name_data = loadmat('/home/smedin7/nfs/spaTIL_python/GraphFeatureDescription.mat')
        names = [f"Graph{str(desc).replace(' ', '')}_G{i + 1}" for desc in name_data['GraphFeatureDescription'][0]]
        #print(len(names))
